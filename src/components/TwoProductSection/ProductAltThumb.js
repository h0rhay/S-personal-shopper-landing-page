...
const ProductAltThumb = ({ alt, src, item, ...delegated }) => {
  ...
  return (
    <div {...delegated} ref={containerRef}>
      <FadeIn delay={(item + 1) * 500} duration={600} isVisible={isVisible}>
        <BoxImg dir="left">
...
ProductAltThumb.propTypes = {
  alt: PropTypes.string,
  item: PropTypes.number,
  src: PropTypes.string,
};

export default ProductAltThumb;
